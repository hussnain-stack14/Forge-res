...
export default function DeliverySection() {
  return (
    <section id="delivery" className="py-14 sm:py-20 lg:py-24 bg-[#090909] relative overflow-hidden">
      {/* Background ambient lighting */}
      <div className="absolute top-1/3 left-10 w-72 sm:w-96 h-72 sm:h-96 bg-[#E33B20]/10 rounded-full blur-3xl pointer-events-none -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 order-1">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-[#292522] shadow-[0_20px_50px_rgba(0,0,0,0.8)] group">
              ...
              <div className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-[#11100F]/90 backdrop-blur-md border border-[#292522] px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg flex items-center gap-2.5 sm:gap-3">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#E33B20]/20 flex items-center justify-center text-[#E33B20]">
                ...
                <div>
                  ...
                  <p className="text-[11px] sm:text-xs font-condensed font-bold text-[#F5EFE5]">
                    30–45 MINS FAST
                  </p>
                </div>
              </div>
          ...
          {/* RIGHT: CONTENT */}
          <div className="lg:col-span-6 order-2 space-y-5 sm:space-y-6">
            {/* Gold Eyebrow */}
            ...
            {/* Delivery Perks Grid */}
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4 pt-1 sm:pt-2">
              <div className="flex items-center gap-3 p-3 bg-[#11100F] border border-[#292522] rounded-xl">
                <div className="w-8 h-8 rounded-lg bg-[#151311] border border-[#292522] flex items-center justify-center text-[#E33B20] shrink-0">
              ...
              <div className="flex items-center gap-3 p-3 bg-[#11100F] border border-[#292522] rounded-xl">
                <div className="w-8 h-8 rounded-lg bg-[#151311] border border-[#292522] flex items-center justify-center text-[#F0B83D] shrink-0">
            ...
            <div className="pt-2 sm:pt-3">
              <a
                ...
                className="group inline-flex items-center justify-center gap-3 w-full xs:w-auto px-7 sm:px-8 py-3.5 sm:py-4 bg-[#E33B20] hover:bg-[#c42f17] text-[#F5EFE5] font-condensed text-xs sm:text-sm font-bold tracking-widest uppercase rounded-lg transition-all duration-300 shadow-[0_0_25px_rgba(227,59,32,0.45)] hover:shadow-[0_0_35px_rgba(227,59,32,0.7)] hover:-translate-y-0.5"
              >
                <span>ORDER NOW</span>
